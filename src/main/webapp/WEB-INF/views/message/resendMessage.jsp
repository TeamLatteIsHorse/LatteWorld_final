...
<body>
	<table>
		<tr>
			<td>받는이 : </td>
			<td>
			<input id="receiveId" type="hidden" name="receiveId" value="${receiveId }">
			${receiveId }
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<span id="byteInfo">0</span>자 / 최대 400자
			</td>
		</tr>
		<tr>
			<td>
			<button id="resendM" type="button">전송</button>
